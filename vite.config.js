  ...
  server: {
    ...
    proxy: {
      "/home/api/admin/subCategory": {
        target: "http://127.0.0.1:7777/service-event/",
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/home/, ""),
      },
      "/home/api/admin/codepromo": {
        target: "http://127.0.0.1:7777/service-purchase/",
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/home/, ""),
      },
      "/home/api/admin/signup": {
        target: "http://127.0.0.1:7777/service-auth/",
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/home/, ""),
      },
      ...
      "/api/statistic/": {
        target: "http://127.0.0.1:7777/service-stat/",
        changeOrigin: true,
        secure: false,
        rewrite: (path) => path.replace(/^\/home/, ""),
      },
